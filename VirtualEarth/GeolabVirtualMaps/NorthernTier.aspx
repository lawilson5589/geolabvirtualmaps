<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NorthernTier.aspx.cs" debug = "true" Inherits="Framingham" EnableEventValidation="false" StylesheetTheme="VE_Theme" %>
...
<head id="Head" runat="server">
    <title>GeoGraphics Lab - NorthernTier </title>
    ...
    <form id="formMain" runat="server">
        <asp:ScriptManager ID="scriptManagerMap" runat="server">
            <Scripts>   
                ...
                <asp:ScriptReference Path="~/js/specific/NorthernTier_BusRoutesAndStops.js" />
            </Scripts>
			<services>	
