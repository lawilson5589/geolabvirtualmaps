...
// IMPORTANT: 
//      The Geolab.KMLPushPinLayer object instance variable this.__ShapeNames will hold all Shapes
// and static member Geolab.KMLPushPinLayer.Layers will track all PolyLineShapeLayers in the map.
// The tho hastables allow quicly access VEMap Objects 
Geolab.KMLPushPinLayer = function(layerID){
...
Geolab.KMLPushPinLayer.Layers = new Geolab.HashTable();
// Prototypes
Geolab.KMLPushPinLayer.prototype = {
    ...
    Invoke: function(args){
            ...
            try{
                ...
                {   
                    ...
                    if(obj.__layer == null){
                        ...
                        Geolab.KMLPushPinLayer.Layers.put(obj.__layer.Name,obj.__layer.iid);
        ...
        //    </services>
        //    Javascript call:
        //    var CapeCodeRoutes = new Geolab.KMLPushPinLayer('CapeCode_Routes');
...
Geolab.KMLPushPinLayer.registerClass('Geolab.KMLPushPinLayer');
